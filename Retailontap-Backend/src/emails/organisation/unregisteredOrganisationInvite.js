export const unregisteredOrganisationInvite = () => {
    return (
        ...
        '                                    <p style="text-align: left !important;">To connect with <b>{invitedByOrganisation}</b> simply click the connect button below to setup you account and get started.</p>\n' +
        '                                    <p style="display:inline-block;margin: 0px !important;padding:10px !important">\n' +
        '                                        <a href="{acceptLink}">\n' +
        '                                            <button type="button" style="height: 33px;display: flex;align-items: center;padding: 8px 10px;justify-content: center;font-weight:bold;color:#fff;background-color: #0B7AFF;border-color: transparent;border-radius: 2px;font-size: 12px;letter-spacing: 0.2px;outline: none;">Connect</button>' +
        '                                        </a>\n' +
        '                                    </p>\n' +
        '                                </div>\n' +
        '                            </td>\n' +
        ...
        '                        <tr>\n' +
        '                            <td class="details">\n' +
        '                                <p style="margin-top:0px !important;">If the URL does not work, try copying and pasting it into your browser</p>\n' +
